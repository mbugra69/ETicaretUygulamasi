...
{path:"admin", component:LayoutComponent, children: [
  {path:"", component: DashboardComponent},
   // boş bırakırsak eğer, boş path tanımlayıp çağrılması gereken componenti çağırıyoruz.
...
{path:"", component:HomeComponent}, // yine path'i boş bıraktık demek ki ana component Home
